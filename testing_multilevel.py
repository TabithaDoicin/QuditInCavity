...
def main():
  ...
  geff = 1
  ep=0.01*geff
  wa = 100            # cavity and atom frequency
  wc = 100
  kappa = 0.01*geff # cavity dissipation rate
  ...
  system = t.MultiLevel(N, D, geff, ep, wc, wa, kappa, gamma, gamma_d, LAMBDA, omega, zeta, alpha, rwa=False)
